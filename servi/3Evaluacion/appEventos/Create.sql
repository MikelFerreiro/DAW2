...
INSERT INTO EVENTOS(NOMBRE, TIPO, FECHA, DESCRIPCION, ID_LOCAL) VALUES ('Gansos Rosas','Conciertos','2019-02-01','Calificados por el batería original de Guns N Roses Steve Adl como el mejor grupo tributo de los Guns en Europa, Gansos Rosas están avalados también por los miles de aficionados y seguidores que les han seguido en los numerosos escenarios que han recorrido durante su primera década de vida. Tras celebrar durante el año 2016 su décimo aniversario, la banda madrileña Gansos Rosas nos proponen en 2019 seguir rememorando con total fidelidad los temas de una de las últimas bandas autenticas de la historia del Rock con una puesta en escena insuperable.',3);
INSERT INTO EVENTOS(NOMBRE, TIPO, FECHA, DESCRIPCION, ID_LOCAL) VALUES ('Letz Zep','Conciertos','2019-02-08','Letz Zep son considerados hoy en día como el mejor grupo tributo a Led Zeppelin, dentro y fuera del Reino Unido. No son un ejercicio de nostalgia, sino de la rebelión contra el tiempo; un grito de representación del corazón contra la mediocridad y el olvido. Una banda formada por 4 músicos ingleses de enorme talento, experimentados y con todo lo necesario para llevar a cabo la tarea de acercar la música de Led Zeppelin a las nuevas generaciones.',3);
